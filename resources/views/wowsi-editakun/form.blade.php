...
<form action="{{ route('wowsi-editakun.perform') }}" method="POST">
  ...
  <div class="row m-auto mt-0 p-5 shadow bg-kertas h-100" style="background-color: #f0e7d7; width: 70%; z-index: 2">
    ...
    <div class="col-md-6 mb-1">
      ...
      <input type="text" name="tempat_lahir" class="form-control borklat" required name="tempat_lahir" value="{{ Auth::user()->tempat_lahir }}" />
    </div>

    <div class="col-md-6 mb-1">
      <label class="form-label">NIM </label>
      <input type="number" class="form-control borklat" required name="nim" value="{{ Auth::user()->nim }}" />
    </div>

    <div class="col-md-6 mb-1">
      <label class="form-label">Tanggal Lahir </label>
      <input type="date" name="tanggal_lahir" class="form-control borklat" required name="tanggal_lahir" value="{{ Auth::user()->tanggal_lahir }}" />
    </div>
    ...
    <div class="col-md-6 mb-1">
      ...
      <select name="jenis_kelamin" class="form-select borklat" aria-label="Default select example " required>
