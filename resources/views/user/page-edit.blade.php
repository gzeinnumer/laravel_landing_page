                            ...
                            <div class="modal-body">
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama Penugasan" required  value="{{ $data->name }}">
                                    </div>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="No Handphone" required  value="{{ $data->no_hp }}">
                                    </div>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group">
